          ...
          {raceState.cars?.map((car: any) => {
            ...
            return (
              <motion.div
                ...
                className={`flex items-center gap-3 px-3 py-2 cursor-pointer border-l-[3px] border-b border-b-white/5 transition-all duration-300 focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none ${
                  isSelected
