...
const TrackMapInner = dynamic(() => import('./TrackMapInner'), {
  ssr: false,
  loading: () => (
    <div className="flex-1 flex items-center justify-center bg-neutral-900 rounded-lg">
      <div className="text-center">
        ...
        <p className="text-neutral-500 font-mono text-xs uppercase tracking-widest animate-pulse">Initializing OpenStreetMap Engine...</p>
      </div>
    </div>
  ),
});
